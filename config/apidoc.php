...
//        ]
        ...
        ['title' => 'api接口', 'path' => 'app\api\controller', 'key' => 'api'],
//        ['title' => '多版本api接口', 'path' => 'app\api\controller', 'key' => 'apiVersioning',
//            'items' => [
//                ['title' => 'V1.0', 'path' => 'app\api\controller\v1', 'key' => 'v1'],
//                ['title' => 'V2.0', 'path' => 'app\api\controller\v2', 'key' => 'v2']
//            ]
//        ],
    ],
    ...
    'params' => [
        ...
        'header' => [
            ...
            ['name' => 'Token', 'type' => 'string', 'require' => false, 'desc' => '身份令牌Token'],
        ],
        // （选配）全局的请求Query
        'query' => [
            // 同上 header
